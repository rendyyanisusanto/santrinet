						...
						<fieldset>
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									<div class="col-lg-6">
										<input type="text" placeholder=""  value="<?= $data_get['data_edit']['nama'] ?>" required name="nama" class="form-control">
									</div>
								</div>
								
								<div class="form-group">
									<label class="col-lg-3 control-label">Kategori Tatib : <i class="text-danger">*</i></label>
									<div class="col-lg-6">
										<select name="kategori_tatib_id" required class="form-control">
											<option value="">Pilih</option>
											<?php foreach ($data_get['kategori_tatib'] as $key => $value): ?>
												<option <?= ($data_get['data_edit']['kategori_tatib_id'] == $value['id']) ? "selected":""; ?> value="<?php echo $value['id'] ?>"><?php echo $value['nama'] ?></option>
											<?php endforeach ?>
										</select>
									</div>
								</div>
								...
								<div class="form-group">
									<label class="col-lg-3 control-label">Poin : <i class="text-danger">*</i></label>
									<div class="col-lg-6">
										<input type="text" placeholder="" value="<?= $data_get['data_edit']['poin'] ?>" required name="poin" class="form-control">
									</div>
								</div>
