    ...
    <div class="col-sm-6">
        <div class="panel panel-default" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
            <div class="panel-heading" style="background-color: #5cb85c; color: white;">
                <h4 class="panel-title">Peserta Sekolah</h4>
            </div>
            <div class="panel-body">
                <select id="sekolahSelect" class="form-control" onchange="tampilkanPesertasekolah()">
                    <option value="">Pilih Sekolah</option>
                    <?php
                        foreach ($data_get['sekolah'] as $key => $value) {
                            ?>
                                <option value="<?= $value['id'];?>"><?= $value['nama'];?></option>
                            <?php
                        }
                ...
                <table class="table table-xxs table-bordered table-striped" style="margin-top: 10px;">
                    ...
                    <tbody id="pesertasekolahList">
                        <tr><td colspan="4" class="text-center">Pilih kelas sekolah untuk melihat peserta</td></tr>
                    </tbody>
                </table>
            </div>
        </div>
