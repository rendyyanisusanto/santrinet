    ...
    <div class="col-sm-6">
        <div class="panel panel-default" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
            ...
            <div class="panel-body">
                <select id="tahunLulusSelect" class="form-control" onchange="tampilkanLulusan()">
                    <option value="">Pilih Tahun Lulus</option>
                    <?php
                        foreach ($data_get['tahun_lulus'] as $value) {
                            ?>
                ...
                <table class="table table-xxs table-bordered table-striped" style="margin-top: 10px;">
                    ...
                    <tbody id="alumniList">
                        <tr><td colspan="4" class="text-center">Pilih tahun</td></tr>
                    </tbody>
                </table>
            </div>
        </div>
