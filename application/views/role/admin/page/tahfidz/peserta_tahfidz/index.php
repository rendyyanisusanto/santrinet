    ...
    <div class="col-sm-6">
        <div class="panel panel-default" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
            <div class="panel-heading" style="background-color: #5cb85c; color: white;">
                <h4 class="panel-title">Peserta Kelas Tahfidz</h4>
            </div>
            <div class="panel-body">
                <select id="tahfidzSelect" class="form-control" onchange="tampilkanPesertatahfidz()">
                    <option value="">Pilih Kelas Tahfidz</option>
                    <?php
                        foreach ($data_get['tahfidz'] as $key => $value) {
                            ?>
                                <option value="<?= $value['id'];?>"><?= $value['nama'];?></option>
                            <?php
                        }
                ...
                <table class="table table-xxs table-bordered table-striped" style="margin-top: 10px;">
                    ...
                    <tbody id="pesertatahfidzList">
                        <tr><td colspan="4" class="text-center">Pilih kelas tahfidz untuk melihat peserta</td></tr>
                    </tbody>
                </table>
            </div>
        </div>
