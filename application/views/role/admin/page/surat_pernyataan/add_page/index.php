					...
					<div class="col-md-12">
						<fieldset>
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<label class="col-lg-3 control-label">Asrama : <i class="text-danger">*</i></label>
									<div class="col-lg-6">
										<select name="asrama_id" required class="form-control">
											<option value="">Pilih</option>
											<?php foreach ($data_get['asrama'] as $key => $value): ?>
