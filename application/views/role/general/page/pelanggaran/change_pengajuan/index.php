...
<div class="row">
	<div class="col-md-12">
		<div class="panel">
			<form id="app-submit" class="form-horizontal" action="<?php echo $data_get['param']['table'] ?>/update_data_pengajuan" method="POST">
				<div class="panel-body">	
					<div class="col-md-12">
						<fieldset>
							<legend class="text-semibold"><?php echo $data_get['param']['title'] ?> - <b>UPDATE DATA</b></legend>
							<input type="hidden" name="id" value="<?php echo $data_get['data_edit']['id']?>">
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									<div class="col-lg-6">
										<input type="text" name="pelanggaran" value="<?php echo $data_get['data_edit']['pelanggaran']?>"  class="form-control">
									</div>
								</div>
								<div class="form-group">
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									<div class="col-lg-6">
										<input class="form-control" type="text"  value="<?php echo $data_get['data_edit']['kronologi']?>" name="kronologi">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-lg-6">
										<img src="<?= base_url('inc/media/pelanggaran/'.$data_get['data_edit']['foto'])?>" style="max-width: 500px;" alt="">
										<input class="form-control" type="hidden" value="<?php echo $data_get['data_edit']['foto']?>" name="foto">
									</div>
								</div>
