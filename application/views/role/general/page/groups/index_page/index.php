		...
		<div class="panel panel-default" >
			<div class="panel-heading">
				<div class="panel-title">
					<a href="<?php echo $data_get['param']['table'] ?>/add_page" style="color:white;" class="btn btn-primary app-item"><i class="icon-plus3"></i> Tambah Groups</a>
			...
			<div class="panel-body" >
				<div class="table-responsive">
					<table class="table datatable-basic table-xxs table-framed table-striped table-hover"  id="tabel-data">
						<thead>
							<tr>
