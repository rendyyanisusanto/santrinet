	...
	<div class="col-md-12">
		<div class="panel panel-default" >
			<div class="panel-heading">
				...
				<a href="<?php echo $data_get['param']['table'] ?>/add_page_kafil" style="color:white;" class="btn btn-primary app-item"><i class="icon-plus3"></i> Tambah <?php echo $data_get['param']['title'] ?></a>
