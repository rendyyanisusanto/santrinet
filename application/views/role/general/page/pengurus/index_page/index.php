		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="panel-title">
					<a href="<?php echo $data_get['param']['table'] ?>/add_page_pengurus" style="color:white;" class="btn btn-primary app-item"><i class="icon-plus3"></i> Tambah Pengurus</a>
					<a href="<?php echo $data_get['param']['table'] ?>/add_page" style="color:white;" class="btn btn-info app-item"><i class="icon-plus3"></i> Tambah Baru</a>
