    ...
    <div class="col-sm-6">
        <div class="panel panel-default" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
            <div class="panel-heading" style="background-color: #5cb85c; color: white;">
                <h4 class="panel-title">Lembaga Pengurus</h4>
            </div>
            <div class="panel-body">
                <select id="lembagaSelect" class="form-control" onchange="tampilkanPengurus()">
                ...
                <table class="table table-xxs table-bordered table-striped" style="margin-top: 10px;">
                    <thead>
                        <tr>
                            <th width="1%">No</th>
                            <th>Nama Santri</th>
                            <th width="5%">Lembaga</th>
                            <th width="2%">Aksi</th>
                        </tr>
                    </thead>
                    <tbody id="santriKamarList">
                        <tr><td colspan="4" class="text-center">Pilih lembaga untuk melihat pengurus</td></tr>
                    </tbody>
                </table>
            </div>
        </div>
