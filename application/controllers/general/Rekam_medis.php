...
class rekam_medis extends MY_Controller {
	public $arr = [
			...
			'order'				=>	['id'	=>	'DESC'],
			'id'				=>	'id',
			'parents_link'		=>	'role/general/page/rekam_medis'
	];
	...
	function print_web(){
		...
		$this->load->view('role/general/page/rekam_medis/print_page/print_web', $data);
	}
	...
	function print_pdf()
	{
		...
		$param	=	[
	          	'url'			=>	'role/general/page/rekam_medis/print_page/cetak_pdf',
	          	'customPaper'	=>	'A4',
	          	'data_value'	=>	[
