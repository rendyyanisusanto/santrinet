...
class pengurus extends MY_Controller {
	public $arr = [
			...
			'order'				=>	['id'	=>	'DESC'],
			'id'				=>	'id',
			'parents_link'		=>	'role/general/page/pengurus'
	];
	...
	function print_web(){
		...
		$this->load->view('role/general/page/pengurus/print_page/print_web', $data);
	}
	...
	function print_pdf()
	{
		...
		$param	=	[
	          	'url'			=>	'role/general/page/pengurus/print_page/cetak_pdf',
	          	'customPaper'	=>	'A4',
	          	'data_value'	=>	[
	...
	function update_data()
	{
		...
		try {
			...
			if ($this->my_update('pengurus', $data, [$this->arr['id'] => $_POST['id']])) {
				echo json_encode([
					'status'	=>	200,
					'msg'		=>	'Data pengurus berhasil ditambahkan'
				]);
