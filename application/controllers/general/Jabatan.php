...
class jabatan extends MY_Controller {
	public $arr = [
			...
			'order'				=>	['id'	=>	'DESC'],
			'id'				=>	'id',
			'parents_link'		=>	'role/general/page/jabatan'
	];
	...
	function print_web(){
		...
		$this->load->view('role/general/page/jabatan/print_page/print_web', $data);
	}
	...
	function print_pdf()
	{
		...
		$param	=	[
	          	'url'			=>	'role/general/page/jabatan/print_page/cetak_pdf',
	          	'customPaper'	=>	'A4',
	          	'data_value'	=>	[
	...
	function simpan_data()
	{
		try {
			...
			if ($this->save_data('jabatan', $data)) {
				echo json_encode([
					'status'	=>	200,
	...
	function update_data()
	{
		...
		try {
			...
			if ($this->my_update('jabatan', $data, [$this->arr['id'] => $_POST['id']])) {
				echo json_encode([
					'status'	=>	200,
					'msg'		=>	'Data jabatan berhasil ditambahkan'
				]);
	...
	public function datatable()
	{
        ...
        foreach ($list as $field) {
            ...
            $row[]		=	'<a href="jabatan/edit_page/'.$field['id'].'" class="app-item"><b>'. (!empty($field['kode']) ? strtoupper($field['kode']) : '-') . '</b></a>';
			...
			$row[]		=	'<ul class="text-center icons-list">
			            					<li class="dropdown">
			            						...
			            						<ul class="dropdown-menu dropdown-menu-right">
			            							<li><a href="jabatan/look_page/'.$field['id'].'" class="app-item"><i class="icon-eye"></i> Lihat</a></li>
			            							<li><a href="jabatan/edit_page/'.$field['id'].'" class="app-item"><i class="icon-pencil"></i> Ubah</a></li>
			            							'.(($field['is_deleted']==1) ? '<li><a  onclick="change_status('.$field['id'].','.$field['status'].');"><i class="icon-close2"></i> '.(($field['status'] == 1) ? "Nonaktifkan" : "Aktifkan" ).'</a></li>' : "").'
