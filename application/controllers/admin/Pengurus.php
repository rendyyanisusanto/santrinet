...
class pengurus extends MY_Controller {
	public $arr = [
			...
			'order'				=>	['id'	=>	'DESC'],
			'id'				=>	'id',
			'parents_link'		=>	'role/admin/page/pengurus'
	];
	...
	function print_web(){
		...
		$this->load->view('role/admin/page/pengurus/print_page/print_web', $data);
	}
	...
	function print_pdf()
	{
		...
		$param	=	[
	          	'url'			=>	'role/admin/page/pengurus/print_page/cetak_pdf',
	          	'customPaper'	=>	'A4',
	          	'data_value'	=>	[
