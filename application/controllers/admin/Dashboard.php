...
class Dashboard extends MY_Controller {
	...
	function get_graph(){
		$this->my_view(['role/admin/page/dashboard/index_page/graph' ,'role/admin/page/dashboard/index_page/js_graph'],$data);
	}

	function get_trans(){
		$this->my_view(['role/admin/page/dashboard/index_page/trans' ,'role/admin/page/dashboard/index_page/js_trans'],$data);
	}
	...
	function get_last_trans(){
		...
		$this->my_view(['role/admin/page/dashboard/index_page/last_trans'],$data);
	}
	...
	function get_top_spender(){
		...
		$this->my_view(['role/admin/page/dashboard/index_page/top_spender'],$data);
	}
	...
	function get_stok_limit(){
		...
		$this->my_view(['role/admin/page/dashboard/index_page/stok_limit'],$data);
	}
	...
	function detail_top_spender($id = "")
	{
		...
		$this->my_view(['role/admin/page/dashboard/index_page/detail_top_spender','role/admin/page/dashboard/index_page/js_detail_top_spender'],$data);	
	}
	function get_so_top_spender($id='')
	{
		$data['so']	=	$this->my_where('v_lap_so', ['customer_id'=>$id])->result_array();

		$this->my_view(['role/admin/page/dashboard/index_page/table_top_spender'],$data);
	}
	function all_top_spender()
	{
		...
		$this->my_view(['role/admin/page/dashboard/index_page/all_top_spender'],$data);
	}
	...
	function all_stock_limit(){
		...
		$data['stok_limit'] = $query;
		$this->my_view(['role/admin/page/dashboard/index_page/all_stock_limit'],$data);
	}
