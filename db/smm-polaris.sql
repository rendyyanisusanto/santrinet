...
CREATE TABLE `check_log`  (
  ...
  `uid_finger` int NULL DEFAULT NULL,
  `status_absen_id` int NULL DEFAULT NULL,
...
CREATE TABLE `detail_bahan_produksi`  (
  ...
  `produksi_id` int NULL DEFAULT NULL,
  `bahan_id` int NULL DEFAULT NULL,
  `qty` int NULL DEFAULT NULL,
  `satuan_id` int NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `produksi_id`(`produksi_id` ASC) USING BTREE,
...
CREATE TABLE `detail_mutasi_bahan`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `mutasi_bahan_id` int NULL DEFAULT NULL,
  `bahan_id` int NULL DEFAULT NULL,
  `qty` int NULL DEFAULT NULL,
...
CREATE TABLE `detail_pemasukan_lain`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `pemasukanlain_id` int NULL DEFAULT NULL,
...
INSERT INTO `detail_pemasukan_lain` VALUES (8, 5, 'Jual A', 50000.00);
INSERT INTO `detail_pemasukan_lain` VALUES (9, 5, 'Jual B', 25000.00);
...
CREATE TABLE `detail_pembayaran_sales_order`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `pembayaran_sales_order_id` int NULL DEFAULT NULL,
...
CREATE TABLE `detail_pembayaran_tagihan`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `pembayaran_tagihan_id` int NULL DEFAULT NULL,
  `metode_pembayaran` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `bank_id` int NULL DEFAULT NULL,
  `jumlah` decimal(20, 0) NULL DEFAULT NULL,
  `keterangan` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL,
...
CREATE TABLE `detail_penerimaan_barang`  (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `penerimaan_barang_id` int UNSIGNED NULL DEFAULT NULL,
  `bahan_id` int NULL DEFAULT NULL,
  `qty_pesan` int NULL DEFAULT NULL,
  `qty_terima` int NULL DEFAULT NULL,
  `satuan_beli_id` int NULL DEFAULT NULL,
...
INSERT INTO `detail_penerimaan_barang` VALUES (101, 43, 145, 5, 5, 6, 10000.00, NULL);
INSERT INTO `detail_penerimaan_barang` VALUES (102, 43, 144, 3, 3, 1, 150000.00, NULL);
...
CREATE TABLE `detail_pengeluaran_lain`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `pengeluaranlain_id` int NULL DEFAULT NULL,
  `keterangan` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL,
  `jumlah` double(20, 2) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `detail_pengeluaran_lain` VALUES (10, 6, 'uang bensin', 50000.00);
INSERT INTO `detail_pengeluaran_lain` VALUES (11, 6, 'uang makan', 25000.00);
...
CREATE TABLE `detail_penyesuaian_stok`  (
  ...
  `penyesuaian_stok_id` int NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Compact;
...
INSERT INTO `detail_purchase_order` VALUES (101, 42, 145, 1, 6, 0.00, 0, 0.00);
INSERT INTO `detail_purchase_order` VALUES (102, 43, 145, 5, 6, 10000.00, 0, 50000.00);
INSERT INTO `detail_purchase_order` VALUES (103, 43, 144, 3, 1, 150000.00, 0, 450000.00);
...
CREATE TABLE `detail_sales_order`  (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `sales_order_id` int UNSIGNED NULL DEFAULT NULL,
  `produk_id` int NULL DEFAULT NULL,
  `qty` int NULL DEFAULT NULL,
  `harga` decimal(20, 2) NULL DEFAULT NULL,
  `diskon` int NULL DEFAULT NULL,
...
CREATE TABLE `detail_surat_jalan`  (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `surat_jalan_id` int UNSIGNED NULL DEFAULT NULL,
  `produk_id` int NULL DEFAULT NULL,
  `qty` int NULL DEFAULT NULL,
  `qty_kirim` int NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `surat_jalan_id`(`surat_jalan_id` ASC) USING BTREE
...
CREATE TABLE `detail_template_produk`  (
  ...
  `satuan_id` int NULL DEFAULT NULL,
  `qty` int NULL DEFAULT NULL,
  `template_produk_id` int NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `template_produk_id`(`template_produk_id` ASC) USING BTREE,
...
CREATE TABLE `histori_stok_bahan`  (
  ...
  `masuk` int NULL DEFAULT NULL,
  `keluar` int NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `histori_stok_bahan` VALUES (151, 146, 'Tambah data bahan Paku 2', '2024-02-06', '2024-02-06 18:46:15', 1, NULL, NULL, 'B/2402-5556', 1, 0);
INSERT INTO `histori_stok_bahan` VALUES (152, 145, 'Tambah data bahan PB/2402-8470', '2024-02-13', '2024-02-13 19:09:05', 1, NULL, NULL, 'PB/2402-8470', 5, 0);
INSERT INTO `histori_stok_bahan` VALUES (153, 144, 'Tambah data bahan PB/2402-8470', '2024-02-13', '2024-02-13 19:09:05', 1, NULL, NULL, 'PB/2402-8470', 3, 0);
...
CREATE TABLE `jabatan`  (
  ...
  `updated_by` int NULL DEFAULT NULL,
  `color` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `is_deleted` tinyint NULL DEFAULT 1,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1000 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = COMPACT;
...
) ENGINE = InnoDB AUTO_INCREMENT = 666 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;
...
INSERT INTO `jurnal_umum` VALUES (660, 'PB/2402-8470', 5, 555000, 0, 'Penerimaan Barang pada tanggal 2024-02-13 dengan Kode PB/2402-8470, No Surat Jalan SJ/2305-0101 dan Pengirim Rendy', 'penerimaan_barang', 43, '2024-02-13 19:09:05', 1);
INSERT INTO `jurnal_umum` VALUES (661, 'PB/2402-8470', 9, 0, 555000, 'Penerimaan Barang pada tanggal 2024-02-13 dengan Kode PB/2402-8470, No Surat Jalan SJ/2305-0101 dan Pengirim Rendy', 'penerimaan_barang', 43, '2024-02-13 19:09:05', 1);
INSERT INTO `jurnal_umum` VALUES (662, 'PML/8018', 1, 75000, 0, 'tes', 'pemasukan_lain', 5, '2024-03-18 19:46:48', 1);
INSERT INTO `jurnal_umum` VALUES (663, 'PML/8018', 19, 0, 75000, 'tes', 'pemasukan_lain', 5, '2024-03-18 19:46:48', 1);
INSERT INTO `jurnal_umum` VALUES (664, 'PL1609', 1, 75000, 0, 'Tambahan biaya pengiriman', 'pengeluaran_lain', 6, '2024-03-22 08:51:39', 1);
INSERT INTO `jurnal_umum` VALUES (665, 'PL1609', 22, 0, 75000, 'Tambahan biaya pengiriman', 'pengeluaran_lain', 6, '2024-03-22 08:51:39', 1);
...
CREATE TABLE `karyawan`  (
  ...
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `updated_by` int UNSIGNED NULL DEFAULT NULL,
  `status_karyawan_id` int NULL DEFAULT NULL,
  `uid_fingerprint` int NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
-- Table structure for komponen_sales_order
-- ----------------------------
DROP TABLE IF EXISTS `komponen_sales_order`;
CREATE TABLE `komponen_sales_order`  (
  `id` int NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of komponen_sales_order
-- ----------------------------
INSERT INTO `komponen_sales_order` VALUES (12, 39, 'diskon', 25000.00);
INSERT INTO `komponen_sales_order` VALUES (14, 46, 'Ongkir', 50000.00);
...
-- ----------------------------
INSERT INTO `master_barang_jadi` VALUES (1, 'PRD - 1', 'Kursi Kantor', NULL, 11, 2, 200000, 2, '2023-02-01 20:58:29', 1, '2024-03-11 10:06:29', 1, 2, 1);
INSERT INTO `master_barang_jadi` VALUES (2, 'PRD - 12', 'MEJA1', 89, 1, 2, 100000, 2, '2023-02-01 21:15:19', 1, '2024-03-11 10:06:29', 1, 1, 1);
INSERT INTO `master_barang_jadi` VALUES (3, 'PRD - 13', 'MEJA 2', 98, 2, 2, 200000, 1, '2023-02-01 21:15:19', 1, '2024-03-11 10:06:29', 1, 2, 1);
INSERT INTO `master_barang_jadi` VALUES (4, 'PRD - 15', 'MEJA3', 95, 3, 1, 300000, 2, '2023-02-01 21:15:19', 1, '2024-03-11 10:06:29', 1, 1, 1);
INSERT INTO `master_barang_jadi` VALUES (5, 'PRD - 14', 'MEJA4', 97, 4, 1, 400000, 1, '2023-02-01 21:15:19', 1, '2024-03-11 10:06:29', 1, 2, 1);
INSERT INTO `master_barang_jadi` VALUES (6, 'PRD - 16', 'MEJA5', 104, 5, 2, 500000, 2, '2023-02-01 21:15:19', 1, '2024-03-11 10:06:29', 1, 1, 1);
INSERT INTO `master_barang_jadi` VALUES (7, 'PRD - 17', 'MEJA6', 105, 6, 2, 600000, 1, '2023-02-01 21:15:19', 1, '2024-03-11 10:06:29', 1, 2, 1);
INSERT INTO `master_barang_jadi` VALUES (8, 'PRD - 18', 'Kursi Gaming', 20, 1, 1, 780000, 1, '2023-02-02 10:45:33', 1, '2024-03-11 10:06:29', 1, 2, 1);
INSERT INTO `master_barang_jadi` VALUES (9, 'PRD - 19', 'Kursi Minimalis 1', 149, 100, 2, 150000, 1, '2023-02-04 13:01:35', 1, '2024-03-11 10:06:29', 1, 1, 1);
...
INSERT INTO `master_data_bahan` VALUES (58, 'B5484497', 'Cat Kayu', 1, 2, NULL, NULL, 1, '2023-02-18 10:14:11', 1, '2024-01-18 10:51:33', 1, 1, 20000.00);
...
INSERT INTO `master_data_bahan` VALUES (63, 'B2508009', 'Cat Top X', 10, 93, NULL, NULL, 1, '2023-02-28 19:13:45', 1, '2024-01-21 13:45:48', NULL, 1, 20000.00);
...
INSERT INTO `master_data_bahan` VALUES (66, 'B4134813', 'Besi A', 0, -484, NULL, NULL, 1, '2023-03-12 19:13:57', 1, '2024-01-21 13:45:48', NULL, 1, 20000.00);
...
INSERT INTO `master_data_bahan` VALUES (90, 'B/2308-9824', 'Cakar 320 PP', 10, 1, NULL, NULL, 1, '2023-08-30 05:33:36', 1, '2024-01-18 10:51:33', NULL, 1, NULL);
...
INSERT INTO `master_data_bahan` VALUES (94, 'B/2308-1555', 'Cakar 350 Crom', 10, 1, NULL, NULL, 1, '2023-08-30 05:35:42', 1, '2024-01-18 10:51:33', NULL, 1, NULL);
...
INSERT INTO `master_data_bahan` VALUES (127, 'B/2309-1713', 'Papan sandaran 200 manager (58 x 52) kotak', 10, 200, NULL, NULL, 1, '2023-09-02 06:18:47', 1, '2024-01-18 10:51:33', NULL, 1, NULL);
INSERT INTO `master_data_bahan` VALUES (128, 'B/2310-5919', 'Paku stainless 0,2', 1, 15, NULL, NULL, 1, '2023-10-22 05:50:09', 1, '2024-01-18 10:51:33', NULL, 1, NULL);
...
INSERT INTO `master_data_bahan` VALUES (144, 'BHN16', 'BAHAN 16', 16, 1604, NULL, NULL, 35, '2023-12-24 18:43:03', NULL, '2024-02-13 19:09:05', 1, 1, NULL);
INSERT INTO `master_data_bahan` VALUES (145, 'BHN17', 'BAHAN 17', 17, 1665, NULL, NULL, 35, '2023-12-24 18:43:03', NULL, '2024-02-13 19:09:05', 1, 1, NULL);
INSERT INTO `master_data_bahan` VALUES (146, 'B/2402-5556', 'Paku 2', 1, 1, NULL, NULL, 1, '2024-02-06 18:46:15', 1, NULL, NULL, 1, NULL);
...
CREATE TABLE `master_data_customer`  (
  ...
  `updated_by` int UNSIGNED NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1025 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;
...
INSERT INTO `master_data_customer` VALUES (1004, 'CUST/07052023/7960/2023', 'Cicik', '081933046907', 'Jl. Penamas RT 47 RW 09 Kebonagung Malang', 15, 257, '', '', 1, '2023-05-07 07:59:13', 1, '2024-03-07 18:21:03', NULL);
...
INSERT INTO `pemasukan_lain` VALUES (5, 'PML/8018', 'tes', '2024-03-18', 75000.00, '2024-03-18 19:46:48', 19, 1);
...
-- ----------------------------
-- Records of pembayaran_purchase_order
-- ----------------------------
...
CREATE TABLE `pembayaran_sales_order`  (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `so_id` int UNSIGNED NULL DEFAULT NULL,
  `kode` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
...
INSERT INTO `penerimaan_barang` VALUES (43, 'PB/2402-8470', 43, 'SJ/2305-0101', 1, '2024-02-13', 'Rendy', '', 0, '2024-02-13 19:09:05', 1, '2024-02-13 19:09:21', 1, 1, NULL, 500000.00, 1, 1, 500000.00, 0.00, 555000.00, 55000.00);
...
-- ----------------------------
INSERT INTO `pengeluaran_lain` VALUES (6, 'PL1609', 'Tambahan biaya pengiriman', '2024-03-22', 75000.00, '2024-03-22 08:51:39', 22, 1);
...
CREATE TABLE `presensi`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `status_shift_id` int NULL DEFAULT NULL,
  `karyawan_id` int NULL DEFAULT NULL,
  `tanggal` date NULL DEFAULT NULL,
  `gudang_id` int NULL DEFAULT NULL,
...
-- Records of produk
-- ----------------------------
INSERT INTO `produk` VALUES (1, 'PRD - 1', 'Kursi Kantor', 119, 11, 2, 200000, 2, '2023-02-01 20:58:29', 1, '2024-03-11 10:06:47', 1, 2, 1);
INSERT INTO `produk` VALUES (2, 'PRD - 12', 'MEJA1', 289, 1, 2, 100000, 2, '2023-02-01 21:15:19', 1, '2024-03-11 10:06:47', 1, 1, 1);
INSERT INTO `produk` VALUES (3, 'PRD - 13', 'MEJA 2', 101, 2, 2, 200000, 1, '2023-02-01 21:15:19', 1, '2024-03-11 10:06:47', 1, 2, 1);
INSERT INTO `produk` VALUES (4, 'PRD - 15', 'MEJA3', 102, 3, 1, 300000, 2, '2023-02-01 21:15:19', 1, '2024-03-11 10:06:47', 1, 1, 1);
INSERT INTO `produk` VALUES (5, 'PRD - 14', 'MEJA4', 87, 4, 1, 400000, 1, '2023-02-01 21:15:19', 1, '2024-03-11 10:06:47', 1, 2, 1);
INSERT INTO `produk` VALUES (6, 'PRD - 16', 'MEJA5', 104, 5, 2, 500000, 2, '2023-02-01 21:15:19', 1, '2024-03-11 10:06:47', 1, 1, 1);
INSERT INTO `produk` VALUES (7, 'PRD - 17', 'MEJA6', 105, 6, 2, 600000, 1, '2023-02-01 21:15:19', 1, '2024-03-11 10:06:47', 1, 2, 1);
INSERT INTO `produk` VALUES (8, 'PRD - 18', 'Kursi Gaming', 20, 1, 1, 780000, 1, '2023-02-02 10:45:33', 1, '2024-03-11 10:06:47', 1, 2, 1);
INSERT INTO `produk` VALUES (9, 'PRD - 19', 'Kursi Minimalis 1', 150, 100, 2, 150000, 1, '2023-02-04 13:01:35', 1, '2024-03-11 10:06:47', 1, 1, 1);
...
INSERT INTO `produk` VALUES (22, 'Produk/5880', 'Kursi Makan Tinggi Putih', 3, 1, 1, 1250000, 1, '2023-08-25 18:19:16', 1, '2023-08-26 14:08:07', 1, 1, 1);
INSERT INTO `produk` VALUES (23, 'prd -5', 'Kursi Makan Hitam', 100, 10, 1, 1000000, 1, '2023-08-25 19:58:14', NULL, '2024-03-11 10:06:53', 1, 1, 0);
...
CREATE TABLE `produk_suplier`  (
  ...
  `created_by` int NULL DEFAULT NULL,
  `updated_by` int NULL DEFAULT NULL,
  `suplier_id` int UNSIGNED NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `purchase_order`  (
  ...
  `total_ppn` decimal(20, 2) NULL DEFAULT NULL,
  `status_aktif` tinyint(1) NULL DEFAULT 1,
  `status_transaksi_id` int NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 44 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;
...
-- ----------------------------
INSERT INTO `purchase_order` VALUES (4, 'PO-6321875', 12, '2023-02-26', '', 0, 0, 915000.00, 2.00, 840000.00, 0, '2023-02-26 09:49:51', 1, '2023-04-18 20:00:13', NULL, 0.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (5, 'PO-3502130', 13, '2023-02-26', '', 1, 11, 2875000.00, 1.00, 3108000.00, 0, '2023-02-26 09:50:44', 1, '2023-04-18 20:00:13', NULL, 30800000.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (6, 'PO-9542057', 12, '2023-02-26', '-', 1, 11, 975000.00, 0.00, 999000.00, 0, '2023-02-26 19:41:06', 1, '2023-04-18 20:00:13', NULL, 9900000.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (7, 'PO-211449', 12, '2023-02-27', '', 1, 11, 1425000.00, 0.00, 1498500.00, 0, '2023-02-27 14:31:19', 1, '2023-04-18 20:00:13', NULL, 14850000.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (8, 'PO-3785850', 15, '2023-02-28', '', 1, 11, 2895000.00, 0.00, 3130200.00, 0, '2023-02-28 18:57:38', 1, '2023-04-18 20:00:13', NULL, 31020000.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (9, 'PO-5894763', 13, '2023-02-28', '', 0, 0, 3370000.00, 0.00, 3295000.00, 0, '2023-02-28 19:18:15', 1, '2023-04-18 20:00:13', NULL, 0.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (10, 'PO-4318686', 13, '2023-02-28', '', 1, 11, 5925000.00, 0.00, 6493500.00, 0, '2023-02-28 19:20:14', 1, '2023-04-18 20:00:13', NULL, 64350000.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (11, 'PO-6694136', 17, '2023-03-12', '', 1, 11, 525000.00, 0.00, 499500.00, 0, '2023-03-12 19:14:26', 1, '2023-04-18 20:00:13', NULL, 4950000.00, 0, NULL);
INSERT INTO `purchase_order` VALUES (12, 'PO-8957202', 16, '2023-03-16', '', 1, 1, 2885000.00, 0.00, 2838100.00, 0, '2023-03-16 19:27:40', 1, '2023-04-18 20:00:13', NULL, 2810000.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (13, 'PO-2123', 12, '2023-03-30', '', 0, 0, 4425000.00, 0.00, 4350000.00, 0, '2023-03-30 09:57:37', 1, '2023-04-18 20:00:13', NULL, 0.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (14, 'PO-6215', 18, '2023-03-31', '', 0, 0, 13425000.00, 0.00, 13350000.00, 0, '2023-03-31 18:15:20', 1, '2023-04-18 20:00:13', NULL, 0.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (15, 'PO-6548', 16, '2023-04-07', '', 1, 1, -75000.00, 0.00, -142500.00, 0, '2023-04-07 18:40:09', 1, '2023-08-24 19:02:47', NULL, 750000.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (16, 'PO-7888', 17, '2023-04-07', '', 1, 1, 1925000.00, 0.00, 1868500.00, 0, '2023-04-07 18:49:12', 1, '2023-04-18 20:00:13', NULL, 1850000.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (17, 'PO-9814', 19, '2023-04-08', '', 1, 11, 12000.00, 0.00, 13320.00, 1, '2023-04-08 14:34:17', 1, '2023-04-18 20:18:30', 1, 1320.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (18, 'PO-6579', 13, '2023-04-08', '', 1, 11, -25000.00, 0.00, -111000.00, 0, '2023-04-08 15:06:22', 1, '2023-04-18 20:00:13', NULL, -1100000.00, 0, NULL);
INSERT INTO `purchase_order` VALUES (19, 'PO-49333', 19, '2023-04-18', 'tes12345', 0, 0, 500000.00, 0.00, 500000.00, 0, '2023-04-18 18:49:42', 1, '2023-04-20 09:10:14', 1, 0.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (20, 'PO-6932', 12, '2023-04-27', '', 0, 0, 10000.00, 0.00, 10000.00, 0, '2023-04-27 15:14:17', 1, NULL, NULL, 0.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (21, 'PO-2978', 12, '2023-05-05', '', 0, 0, 800000.00, 0.00, 800000.00, 0, '2023-05-05 18:27:58', 1, NULL, NULL, 0.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (22, 'PO-4497', 18, '2023-05-05', '', 0, 0, 3000000.00, 0.00, 3000000.00, 0, '2023-05-05 18:46:36', 1, NULL, NULL, 0.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (23, 'PO-3806', 18, '2023-05-07', '', 0, 0, 162500.00, 0.00, 162500.00, 0, '2023-05-07 14:46:08', 1, '2023-05-07 14:47:01', 1, 0.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (24, 'PO-2994', 18, '2023-05-07', '', 0, 0, 500000.00, 0.00, 500000.00, 0, '2023-05-07 15:17:21', 1, '2023-05-07 15:19:36', 1, 0.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (25, 'PO-202305-719', 20, '2023-05-20', '', 1, 11, 570000.00, 0.00, 632700.00, 0, '2023-05-20 21:08:12', 1, NULL, NULL, 62700.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (26, 'PO-2306-7498', 21, '2023-06-06', '', 0, 0, 100.00, 0.00, 100.00, 0, '2023-06-06 20:24:04', 1, NULL, NULL, 0.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (27, 'PO-2306-2978', 17, '2023-06-06', '', 0, 0, 10270000.00, 0.00, 10270000.00, 0, '2023-06-06 20:27:02', 1, NULL, NULL, 0.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (28, 'PO-2306-1106', 17, '2023-06-10', 'asd', 0, 0, 3500000.00, 0.00, 3500000.00, 0, '2023-06-10 08:33:59', 1, '2023-06-10 08:43:39', 1, 0.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (29, 'PO-2306-4540', 22, '2023-06-10', '', 1, 11, 500000.00, 0.00, 610000.00, 0, '2023-06-10 09:35:35', 1, '2023-08-24 19:02:03', 1, 110000.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (30, 'PO-2306-8624', 22, '2023-06-10', '', 0, 0, 0.00, 20.00, -200000.00, 0, '2023-06-10 09:49:41', 1, '2023-08-24 19:02:03', NULL, 0.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (31, 'PO-2306-3655', 22, '2023-06-10', '', 1, 11, 500000.00, 10.00, 499200.00, 0, '2023-06-10 11:57:25', 1, '2023-08-24 19:02:03', NULL, 79200.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (32, 'PO-2306-6592', 12, '2023-06-10', '', 0, 0, 800000.00, 0.00, 800000.00, 0, '2023-06-10 12:10:01', 1, NULL, NULL, 0.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (33, 'PO-2306-7414', 20, '2023-06-10', '', 1, 11, 1100000.00, 10.00, 1098900.00, 0, '2023-06-10 16:40:56', 1, NULL, NULL, 108900.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (34, 'PO/2308-1897', 23, '2023-08-23', 'Pembelian Bahan Baku', 1, 11, 592000.00, 0.00, 657120.00, 0, '2023-08-23 18:02:50', 1, '2023-08-23 18:03:29', 1, 65120.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (35, 'PO/2308-3075', 22, '2023-08-23', 'Uji Coba', 1, 11, 180000.00, 0.00, 199800.00, 0, '2023-08-23 18:37:15', 1, NULL, NULL, 19800.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (36, 'PO/2308-6128', 20, '2023-08-24', '', 1, 11, 500000.00, 0.00, 555000.00, 0, '2023-08-24 18:38:16', 1, NULL, NULL, 55000.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (37, 'PO/2310-5029', 17, '2023-10-21', 'Papan Sandaran', 1, 11, 15000000.00, 0.00, 16650000.00, 0, '2023-10-21 21:16:16', 1, '2023-10-21 21:16:28', 1, 1650000.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (38, 'PO/2310-7377', 17, '2023-10-21', 'Papan Sandaran', 1, 11, 15000000.00, 0.00, 16650000.00, 0, '2023-10-21 21:27:23', 1, NULL, NULL, 1650000.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (39, 'PO/2310-4415', 13, '2023-10-21', '-', 1, 11, 1400000.00, 0.00, 1554000.00, 1, '2023-10-21 21:39:27', 1, NULL, NULL, 154000.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (40, 'PO/2312-7114', 12, '2023-12-26', '', 1, 11, 750000.00, 0.00, 832500.00, 0, '2023-12-26 20:15:11', 1, NULL, NULL, 82500.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (41, 'PO/2401-3684', 13, '2024-01-17', '', 0, 0, 4672000.00, 0.00, 4672000.00, 0, '2024-01-17 18:52:12', 1, '2024-01-18 10:50:54', 1, 0.00, 1, NULL);
INSERT INTO `purchase_order` VALUES (42, 'PO/2401-7083', 15, '2024-01-31', '', 0, 0, 0.00, 0.00, 0.00, 1, '2024-01-31 09:27:31', 1, '2024-01-31 09:30:28', 1, 0.00, 1, 1);
INSERT INTO `purchase_order` VALUES (43, 'PO/2402-2027', 20, '2024-02-13', '', 0, 0, 500000.00, 0.00, 500000.00, 0, '2024-02-13 18:58:56', 1, NULL, NULL, 0.00, 1, 1);
...
CREATE TABLE `sales_order`  (
  ...
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `updated_by` int NULL DEFAULT NULL,
  `status_produksi` tinyint NULL DEFAULT 0,
  `status_aktif` tinyint(1) NULL DEFAULT 1,
  `count_print` int NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `sales_order` VALUES (1, 2, 'INV/SO/3291483', '2023-03-11', '1', 1, 11, 500000.00, 0.00, 55000.00, 0, 1100000.00, '2023-03-11 19:24:35', 1, '2023-03-22 10:42:46', NULL, 0, 1, 0);
INSERT INTO `sales_order` VALUES (2, 1, 'INV/SO/3292711', '2023-03-11', 'ew', 1, 11, 300000.00, 1.00, 32670.00, 0, 1100000.00, '2023-03-11 19:25:33', 1, '2023-03-22 10:37:19', NULL, 0, 1, 0);
INSERT INTO `sales_order` VALUES (3, 1, 'INV/SO/9815617', '2023-03-11', 'ew', 1, 11, 1696000.00, 1.00, 184694.40, 0, 1100000.00, '2023-03-11 19:59:54', 1, NULL, NULL, 0, 1, 0);
INSERT INTO `sales_order` VALUES (7, 2, 'INV/SO/113393', '2023-03-11', 'asd', 1, 11, 897000.00, 0.00, 98670.00, 0, 300000.00, '2023-03-11 20:05:35', 1, NULL, NULL, 0, 1, 0);
INSERT INTO `sales_order` VALUES (8, 2, 'INV/SO/174716', '2023-03-11', '123', 1, 11, 1100000.00, 0.00, 121000.00, 0, 1221000.00, '2023-03-11 20:07:53', 1, NULL, NULL, 0, 1, 0);
INSERT INTO `sales_order` VALUES (9, 2, 'INV/SO/3339440', '2023-03-12', '', 1, 11, 100000.00, 0.00, 11000.00, 0, 111000.00, '2023-03-12 19:20:03', 1, NULL, NULL, 0, 1, 0);
INSERT INTO `sales_order` VALUES (10, 2, 'INV/SO/128', '2023-04-07', 'tes', 0, 0, 600000.00, 0.00, 0.00, 0, 600000.00, '2023-04-07 11:11:00', 1, NULL, NULL, 1, 1, 0);
INSERT INTO `sales_order` VALUES (11, 2, 'INV/SO/992', '2023-04-07', '', 1, 11, 600000.00, 0.00, 66000.00, 0, 666000.00, '2023-04-07 19:16:37', 1, NULL, NULL, 1, 1, 0);
INSERT INTO `sales_order` VALUES (12, 1000, 'INV/SO/999', '2023-04-08', '-', 1, 11, 2700000.00, 0.00, 297000.00, 1, 2997000.00, '2023-04-08 13:28:50', 1, NULL, NULL, 1, 1, 0);
INSERT INTO `sales_order` VALUES (13, 1000, 'INV/SO/50', '2023-04-08', '', 0, 0, 200000.00, 0.00, 0.00, 1, 200000.00, '2023-04-08 14:40:55', 1, NULL, NULL, 0, 1, 0);
INSERT INTO `sales_order` VALUES (14, 1001, 'INV/SO/8198', '2023-04-08', '', 1, 11, 900000.00, 0.00, 99000.00, 0, 999000.00, '2023-04-08 14:42:54', 1, NULL, NULL, 1, 1, 0);
INSERT INTO `sales_order` VALUES (15, 1000, 'INV/SO/8308', '2023-04-08', '', 1, 11, 200000.00, 0.00, 22000.00, 0, 222000.00, '2023-04-08 15:15:28', 1, NULL, NULL, 0, 1, 0);
INSERT INTO `sales_order` VALUES (16, 1001, 'INV/SO/6390', '2023-04-08', '', 1, 11, 1200000.00, 0.00, 132000.00, 0, 1332000.00, '2023-04-08 15:17:13', 1, NULL, NULL, 1, 1, 0);
INSERT INTO `sales_order` VALUES (17, 1002, 'INV/SO/6014', '2023-05-06', '', 0, 0, 500000.00, 0.00, 0.00, 0, 500000.00, '2023-05-06 20:08:29', 1, NULL, NULL, 0, 1, 0);
INSERT INTO `sales_order` VALUES (18, 1003, 'INV/SO/6999', '2023-05-06', '', 0, 0, 200000.00, 0.00, 0.00, 0, 200000.00, '2023-05-06 20:10:15', 1, NULL, NULL, 0, 1, 0);
INSERT INTO `sales_order` VALUES (19, 1004, 'INV/SO/5514', '2023-05-07', '', 0, 0, 200000.00, 0.00, 0.00, 0, 200000.00, '2023-05-07 07:59:54', 1, NULL, NULL, 0, 1, 0);
INSERT INTO `sales_order` VALUES (20, 1003, 'INV/SO/6965', '2023-05-07', '', 0, 0, 1500000.00, 0.00, 0.00, 0, 1500000.00, '2023-05-07 12:46:08', 1, NULL, NULL, 0, 1, 0);
INSERT INTO `sales_order` VALUES (21, 1003, 'INV/SO/7220', '2023-05-07', '', 0, 0, 700000.00, 0.00, 0.00, 0, 700000.00, '2023-05-07 15:23:15', 1, NULL, NULL, 0, 1, 0);
INSERT INTO `sales_order` VALUES (22, 1003, 'INV/SO/5452', '2023-05-07', '', 0, 0, 800000.00, 0.00, 0.00, 0, 800000.00, '2023-05-07 15:29:12', 1, NULL, NULL, 1, 1, 0);
INSERT INTO `sales_order` VALUES (23, 1005, 'SO-202305-5369', '2023-05-20', '', 1, 11, 5660000.00, 0.00, 622600.00, 0, 6282600.00, '2023-05-20 22:07:36', 1, NULL, NULL, 0, 1, 0);
INSERT INTO `sales_order` VALUES (24, 1001, 'SO-2305-1401', '2023-08-02', '', 0, 0, 150000.00, 0.00, 0.00, 1, 150000.00, '2023-05-20 23:39:15', 1, '2023-08-10 15:27:45', NULL, 0, 1, 0);
INSERT INTO `sales_order` VALUES (25, 2, 'SO-2305-6393', '2023-08-03', '', 0, 0, 1200000.00, 0.00, 0.00, 1, 1200000.00, '2023-05-21 07:53:20', 1, '2023-08-10 15:27:45', NULL, 0, 1, 0);
INSERT INTO `sales_order` VALUES (26, 1003, 'SO-2306-5524', '2023-08-04', '', 0, 0, 400000.00, 0.00, 0.00, 0, 400000.00, '2023-06-05 16:46:43', 1, '2023-08-10 15:27:45', NULL, 0, 1, 0);
INSERT INTO `sales_order` VALUES (27, 1002, 'SO-2306-5978', '2023-08-02', '', 0, 0, 1200000.00, 0.00, 0.00, 0, 1200000.00, '2023-06-05 17:49:04', 1, '2023-08-10 15:27:45', NULL, 0, 1, 0);
INSERT INTO `sales_order` VALUES (28, 1004, 'SO-2306-1007', '2023-08-02', '', 0, 0, 400000.00, 0.00, 0.00, 0, 400000.00, '2023-06-05 18:58:51', 1, '2023-08-10 15:27:34', NULL, 0, 1, 0);
INSERT INTO `sales_order` VALUES (29, 1003, 'SO-2306-2567', '2023-08-02', '', 0, 0, 1600000.00, 0.00, 0.00, 0, 1600000.00, '2023-06-05 19:25:48', 1, '2023-08-10 15:27:34', NULL, 0, 1, 0);
INSERT INTO `sales_order` VALUES (30, 1003, 'SO-2306-2828', '2023-08-02', '', 0, 0, 700000.00, 0.00, 0.00, 0, 700000.00, '2023-06-05 20:44:11', 1, '2023-08-10 15:27:32', NULL, 0, 1, 0);
INSERT INTO `sales_order` VALUES (31, 1, 'SO-2306-3923', '2023-08-09', '123', 0, 0, 400000.00, 0.00, 0.00, 1, 400000.00, '2023-06-07 14:47:01', 1, '2023-08-10 15:27:22', NULL, 0, 1, 0);
INSERT INTO `sales_order` VALUES (32, 1005, 'SO-2306-3006', '2023-08-09', 'tesete123', 1, 11, 2127250.00, 5.00, 222297.63, 1, 2243185.13, '2023-06-07 14:58:19', 1, '2023-08-10 15:27:22', 1, 1, 1, 0);
INSERT INTO `sales_order` VALUES (33, 1, 'SO-2306-3330', '2023-08-09', '', 0, 0, 1500000.00, 0.00, 0.00, 1, 1500000.00, '2023-06-07 18:50:14', 1, '2023-08-10 15:27:22', NULL, 1, 1, 0);
INSERT INTO `sales_order` VALUES (34, 1003, 'SO-2306-9708', '2023-08-09', '', 0, 0, 1250000.00, 0.00, 0.00, 0, 1250000.00, '2023-06-08 14:11:18', 1, '2023-08-10 15:27:19', 1, 0, 0, 0);
INSERT INTO `sales_order` VALUES (35, 1, 'SO-2306-6335', '2023-08-09', '', 0, 0, 200000.00, 0.00, 0.00, 0, 200000.00, '2023-06-09 10:28:11', 1, '2023-08-10 11:36:49', NULL, 0, 1, 0);
INSERT INTO `sales_order` VALUES (36, 1006, 'SO-2308-8562', '2023-08-25', '', 1, 11, 2500000.00, 0.00, 275000.00, 0, 2775000.00, '2023-08-25 19:53:44', 1, NULL, NULL, 0, 1, 0);
INSERT INTO `sales_order` VALUES (37, 1004, 'SO-2308-1574', '2023-08-25', '', 1, 11, 8250000.00, 0.00, 907500.00, 0, 9157500.00, '2023-08-25 19:58:14', 1, '2024-03-21 11:04:37', NULL, 1, 1, 4);
INSERT INTO `sales_order` VALUES (38, 1000, 'SO-2308-7044', '2023-08-26', '-', 1, 11, 1350000.00, 0.00, 148500.00, 0, 1498500.00, '2023-08-26 14:03:32', 1, NULL, NULL, 0, 1, 0);
INSERT INTO `sales_order` VALUES (39, 1002, 'SO-2308-9077', '2023-08-26', '', 1, 11, 400000.00, 0.00, 44000.00, 0, 444000.00, '2023-08-26 15:20:37', 1, '2024-03-21 11:02:15', NULL, 0, 1, 69);
...
) ENGINE = InnoDB AUTO_INCREMENT = 106 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;
...
INSERT INTO `setting_table` VALUES (6, 'master_data_bahan', 'kode', 'B/{year}{month}-{rand}', NULL);
...
INSERT INTO `setting_table` VALUES (81, 'sales_order', 'template_nota_header', '<h3 style=\"margin: 0;\"><strong>IMPACT FURNITURE</strong></h3>\r\n\r\n<p style=\"margin: 0;font-size: 12px;\">Jl. Pogot No.72, Tanah Kali Kedinding, Kec. Kenjeran, Surabaya, Jawa Timur 60129</p>\r\n\r\n<p style=\"margin: 0;font-size: 12px;\">No. Telp/HP : 081334791464</p>\r\n', NULL);
...
INSERT INTO `setting_table` VALUES (101, 'pemasukan_lain', 'template_nota_header', '<h3 style=\"margin: 0;\"><strong>IMPACT FURNITURE</strong></h3>\r\n\r\n<p style=\"margin: 0;font-size: 12px;\">Jl. Pogot No.72, Tanah Kali Kedinding, Kec. Kenjeran, Surabaya, Jawa Timur 60129</p>\r\n\r\n<p style=\"margin: 0;font-size: 12px;\">No. Telp/HP : 081334791464</p>\r\n', NULL);
INSERT INTO `setting_table` VALUES (102, 'pemasukan_lain', 'template_nota_footer', '<center style=\"margin-top: 10%;\"><b>** <em>TERIMAKASIH ATAS KUNJUNGAN DAN&nbsp;PEMBELIANNYA</em>**</b></center>\r\n', NULL);
INSERT INTO `setting_table` VALUES (103, 'pemasukan_lain', 'template_struk_header', '<center>\r\n<h4 style=\"margin-bottom: 0;\"><b>Struk Mutasi</b></h4>\r\n<b style=\"margin-top: 0;\">POLARIS FURNITURE</b>\r\n\r\n<p style=\"margin-top: 0;\">Jalan Pogot no. 72, Surabaya - 60129</p>\r\n</center>\r\n', NULL);
INSERT INTO `setting_table` VALUES (104, 'pemasukan_lain', 'template_struk_footer', '<center style=\"margin-top: 10%;\"><b>** <em>Telah diverifikasi admin&nbsp;</em>**</b></center>\r\n', NULL);
INSERT INTO `setting_table` VALUES (105, 'pengeluaran_lain', 'trans_code', 'PL{rand}', NULL);
...
CREATE TABLE `status_transaksi`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `status_transaksi` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Compact;
...
-- ----------------------------
INSERT INTO `status_transaksi` VALUES (1, 'CASH');
INSERT INTO `status_transaksi` VALUES (2, 'JATUH TEMPO');
...
CREATE TABLE `surat_jalan`  (
  ...
  `keterangan` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL,
  `status` tinyint NULL DEFAULT NULL,
  `status_kirim` tinyint NULL DEFAULT 0,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `created_by` int NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `updated_by` int NULL DEFAULT NULL,
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (1, '127.0.0.1', 'administrator', '$2y$10$dxrlMRQtUt9vRv6IiSXLkegTZQtnpumaSX2dZRHtAkwgIBUrB1/Si', 'admin@admin.com', NULL, '', NULL, NULL, NULL, NULL, NULL, 1268889823, 1711071679, 1, 'Admin', 'istrator', 'ADMIN', '0', '101711', NULL, NULL, NULL);
...
INSERT INTO `users` VALUES (10, '180.248.26.63', 'ahmet', '$2y$10$ISDX16pxB0WIsoBR0J.Rzen3jglMRES0cNNav7iIYI3SuP84C6o/C', 'ahmad123@impact.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1699756408, 1701129921, 1, 'ahmad driver', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `users` VALUES (11, '::1', 'sambo', '$2y$10$lKVNmY09DlwxyINsmHuZNu9aYTLoCYO51AOMDpSdTfXp/E/Ht08hq', 'sambo@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1703388839, NULL, 1, 'Ramadhani Samboga, S.Pd', NULL, NULL, NULL, NULL, NULL, 29, 'karyawan');
INSERT INTO `users` VALUES (12, '::1', 'rys', '$2y$10$K5ENW0NTKXMQMh.IpDWv4u1jw6CCdo/KCLu8CxSbJltq4JD0lOUwe', 'rendyyanisusanto@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1706180466, 1706670263, 1, 'Rendy Yani Susanto', NULL, NULL, NULL, NULL, NULL, 1, 'karyawan');
...
delimiter ;;
CREATE TRIGGER `stok_produksi` AFTER INSERT ON `detail_bahan_produksi` FOR EACH ROW BEGIN
...
delimiter ;;
CREATE TRIGGER `update_stok_produksi` AFTER UPDATE ON `detail_bahan_produksi` FOR EACH ROW BEGIN
...
delimiter ;;
CREATE TRIGGER `update_stok` AFTER UPDATE ON `detail_penerimaan_barang` FOR EACH ROW BEGIN
...
delimiter ;;
CREATE TRIGGER `rem_stok` AFTER INSERT ON `detail_sales_order` FOR EACH ROW BEGIN
...
delimiter ;;
CREATE TRIGGER `produk_stok` AFTER INSERT ON `detail_surat_jalan` FOR EACH ROW BEGIN
...
delimiter ;;
CREATE TRIGGER `produk_stok_update` AFTER UPDATE ON `detail_surat_jalan` FOR EACH ROW BEGIN
...
delimiter ;;
CREATE TRIGGER `produk_stok_del` AFTER DELETE ON `detail_surat_jalan` FOR EACH ROW BEGIN
...
delimiter ;;
CREATE TRIGGER `histori_stok` AFTER INSERT ON `master_data_bahan` FOR EACH ROW BEGIN
...
delimiter ;;
CREATE TRIGGER `histori_stok_hapus` AFTER DELETE ON `master_data_bahan` FOR EACH ROW BEGIN
...
delimiter ;;
CREATE TRIGGER `edit_pso` AFTER UPDATE ON `pembayaran_sales_order` FOR EACH ROW BEGIN
	-- 	Debit
...
delimiter ;;
CREATE TRIGGER `jurnal_pb_update` AFTER UPDATE ON `penerimaan_barang` FOR EACH ROW BEGIN
	-- 	Debit
...
-- ----------------------------
DROP TRIGGER IF EXISTS `jurnal_pengeluaran_lain`;
delimiter ;;
CREATE TRIGGER `jurnal_pengeluaran_lain` AFTER INSERT ON `pengeluaran_lain` FOR EACH ROW BEGIN
-- 	Debit
	INSERT into jurnal_umum(ref, akun_id, debit, kredit, keterangan, jurnal_umum.table, table_id) VALUES (new.trans_code, new.akun_kas, new.total, 0, new.keterangan, "pengeluaran_lain", new.id);
-- 	Kredit
	INSERT into jurnal_umum(ref, akun_id, debit, kredit, keterangan, jurnal_umum.table, table_id) VALUES (new.trans_code, new.akun_beban, 0, new.total, new.keterangan, "pengeluaran_lain", new.id);
